...
#define MADB_PROCEDURE_COLUMNS_BUFFER_LEN \
    "CASE DATA_TYPE WHEN 'bit' THEN ((NUMERIC_PRECISION + 7) / 8)" \
    " WHEN 'tinyint' THEN 1" \
    " WHEN 'smallint' THEN 2" \
    " WHEN 'mediumint' THEN 3" \
    " WHEN 'int' THEN 4" \
    ...
    " WHEN 'float' THEN 4"\
    " WHEN 'decimal' THEN NUMERIC_PRECISION" \
    " WHEN 'newdecimal' THEN NUMERIC_PRECISION" \
    " WHEN 'date' THEN 10" \
    " WHEN 'time' THEN 8" \
    " WHEN 'datetime' THEN IF(DTD_IDENTIFIER like '%%datetime(6)%%', 26, 19)" \
    " WHEN 'timestamp' THEN IF(DTD_IDENTIFIER like '%%timestamp(6)%%', 26, 19)" \
    " WHEN 'year' THEN 2" \
    " ELSE CHARACTER_OCTET_LENGTH END :> INT"
...
#define MADB_PROCEDURE_COLUMNS_DATA_TYPE_UNICODE \
    ...
    " WHEN 'text' THEN IF(DTD_IDENTIFIER LIKE '%%blob%%', " XSTR(SQL_VARBINARY) ", " XSTR(SQL_WVARCHAR) ")" \
    " WHEN 'tinytext' THEN IF(DTD_IDENTIFIER LIKE '%%tinyblob%%', " XSTR(SQL_VARBINARY) ", " XSTR(SQL_WVARCHAR) ")"
...
#define MADB_PROCEDURE_COLUMNS_DATA_TYPE_ANSI \
    ...
    " WHEN 'text' THEN IF(DTD_IDENTIFIER LIKE '%%blob%%', " XSTR(SQL_VARBINARY) ", " XSTR(SQL_VARCHAR) ")" \
    " WHEN 'tinytext' THEN IF(DTD_IDENTIFIER LIKE '%%tinyblob%%', " XSTR(SQL_VARBINARY) ", " XSTR(SQL_VARCHAR) ")"
...
#define MADB_PROCEDURE_COLUMNS_SQL_DATA_TYPE_ODBC3A MADB_DATA_TYPE_NUMERIC MADB_SQL_DATA_TYPE_ODBC3 MADB_PROCEDURE_COLUMNS_DATA_TYPE_ANSI MADB_DATA_TYPE_BINARY
#define MADB_PROCEDURE_COLUMNS_SQL_DATA_TYPE_ODBC3U MADB_DATA_TYPE_NUMERIC MADB_SQL_DATA_TYPE_ODBC3 MADB_PROCEDURE_COLUMNS_DATA_TYPE_UNICODE MADB_DATA_TYPE_BINARY
#define MADB_PROCEDURE_COLUMNS_SQL_DATA_TYPE_ODBC2A MADB_DATA_TYPE_NUMERIC MADB_DATA_TYPE_ODBC2 MADB_PROCEDURE_COLUMNS_DATA_TYPE_ANSI MADB_DATA_TYPE_BINARY
#define MADB_PROCEDURE_COLUMNS_SQL_DATA_TYPE_ODBC2U MADB_DATA_TYPE_NUMERIC MADB_DATA_TYPE_ODBC2 MADB_PROCEDURE_COLUMNS_DATA_TYPE_UNICODE MADB_DATA_TYPE_BINARY

#define MADB_PROCEDURE_COLUMNS_ODBC3U MADB_PROCEDURE_COLUMNSp1 MADB_PROCEDURE_COLUMNS_DATA_TYPE_ODBC3U MADB_PROCEDURE_COLUMNSp2 MADB_PROCEDURE_COLUMNS_SQL_DATA_TYPE_ODBC3U MADB_PROCEDURE_COLUMNSp3
#define MADB_PROCEDURE_COLUMNS_ODBC2U MADB_PROCEDURE_COLUMNSp1 MADB_PROCEDURE_COLUMNS_DATA_TYPE_ODBC2U MADB_PROCEDURE_COLUMNSp2 MADB_PROCEDURE_COLUMNS_SQL_DATA_TYPE_ODBC2U MADB_PROCEDURE_COLUMNSp3
#define MADB_PROCEDURE_COLUMNS_ODBC3A MADB_PROCEDURE_COLUMNSp1 MADB_PROCEDURE_COLUMNS_DATA_TYPE_ODBC3A MADB_PROCEDURE_COLUMNSp2 MADB_PROCEDURE_COLUMNS_SQL_DATA_TYPE_ODBC3A MADB_PROCEDURE_COLUMNSp3
#define MADB_PROCEDURE_COLUMNS_ODBC2A MADB_PROCEDURE_COLUMNSp1 MADB_PROCEDURE_COLUMNS_DATA_TYPE_ODBC2A MADB_PROCEDURE_COLUMNSp2 MADB_PROCEDURE_COLUMNS_SQL_DATA_TYPE_ODBC2A MADB_PROCEDURE_COLUMNSp3
