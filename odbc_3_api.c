...
//#define TRACE_API_ON
#ifdef TRACE_API_ON
#define TRACE_API printf("%s\n", __PRETTY_FUNCTION__);
#define TRACE_API_INT(val) printf("%s %d\n", __PRETTY_FUNCTION__, val);
#else
#define TRACE_API
#define TRACE_API_INT(val)
#endif // TRACE_API_ON
