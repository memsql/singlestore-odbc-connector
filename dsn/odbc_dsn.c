...
MADB_DsnMap DsnMap[] = {
  ...
  {&DsnKeys[31], 4, cbTls11,              1, 0},
  {&DsnKeys[31], 4, cbTls12,              2, 0},
  {&DsnKeys[31], 4, cbTls13,              4, 0},
  {&DsnKeys[32], 4, cbForceTls,           0, 0},
  {&DsnKeys[26], 4, txtCrl,               0, 0},
  {&DsnKeys[24], 4, txtTlsPeerFp,       260, 0},
  {&DsnKeys[25], 4, txtTlsPeerFpList,   260, 0},
  {NULL, 0, 0, 0, 0}
};
