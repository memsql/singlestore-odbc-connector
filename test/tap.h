...
#define EXEC_DIRECT_NO_DATA(stmt, query)        EXPECT_STMT(stmt, SQLExecDirect(stmt, (SQLCHAR*)query, SQL_NTS), SQL_NO_DATA)
...
#define EXECUTE_NO_DATA(stmt)                   EXPECT_STMT(stmt, SQLExecute(stmt), SQL_NO_DATA)
